...
var SetEvent = (function (_super) {
    ...
    */
    ...
    SetEvent.SET_EXTRA_BONUS = 'SET_EXTRA_BONUS';
    SetEvent.BONUS_CLICKIDX = 'BONUS_CLICKIDX';
    SetEvent.TOOLS_SHOW = 'TOOLS_SHOW';
    SetEvent.EXTRA_BONUS_SHOWBONUS = 'EXTRA_BONUS_SHOWBONUS';
    SetEvent.EXTRA_BONUS_OVER = 'EXTRA_BONUS_OVER';
    return SetEvent;
}(egret.Event));
