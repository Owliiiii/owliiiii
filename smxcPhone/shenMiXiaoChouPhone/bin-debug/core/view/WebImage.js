...
var WebImage = (function (_super) {
    ...
    function WebImage(src, isbg) {
        ...
        if (!imgWrapperDom) {
            ...
            imgWrapperDom.style.zIndex = '999997';
            if (isbg) {
                imgWrapperDom.style.position = "fixed";
                imgWrapperDom.style.height = "100%";
                imgWrapperDom.style.width = "100%";
                imgWrapperDom.style.left = "0";
                imgWrapperDom.style.top = "0";
                imgWrapperDom.style.right = "0";
                imgWrapperDom.style.bottom = "0";
    ...
    Object.defineProperty(WebImage.prototype, "width", {
        ...
        set: function (value) {
            ...
            if (this._scaleMode == egret.StageScaleMode.FIXED_WIDTH || this._scaleMode == egret.StageScaleMode.FIXED_HEIGHT) {
                ...
                this._imgWrapper.style.width = this.scale * this._width / this._stageW * this._windowW + "px";
            }
            if (this._scaleMode == egret.StageScaleMode.SHOW_ALL || this._scaleMode == egret.StageScaleMode.NO_BORDER) {
                if (this._windowW == this._displayW) {
                    ...
                    this._imgWrapper.style.width = this.scale * this._width / this._stageW * this._displayW + "px";
                }
            }
        },
        enumerable: true,
    ...
    Object.defineProperty(WebImage.prototype, "height", {
        ...
        set: function (value) {
            ...
            if (this._scaleMode == egret.StageScaleMode.FIXED_WIDTH || this._scaleMode == egret.StageScaleMode.FIXED_HEIGHT) {
                ...
                this._imgWrapper.style.height = this.scale * this._height / this._stageH * this._windowH + "px";
            }
            if (this._scaleMode == egret.StageScaleMode.SHOW_ALL || this._scaleMode == egret.StageScaleMode.NO_BORDER) {
                if (this._windowH == this._displayH) {
                    ...
                    this._imgWrapper.style.height = this.scale * this._height / this._stageH * this._displayH + "px";
                }
            }
        },
        enumerable: true,
    ...
    Object.defineProperty(WebImage.prototype, "x", {
        ...
        set: function (value) {
            this._x = value;
            if (this._scaleMode == egret.StageScaleMode.FIXED_WIDTH || this._scaleMode == egret.StageScaleMode.FIXED_HEIGHT) {
                this._imgWrapper.style.left = this.scale * this._x / this._stageW * this._windowW + "px";
            }
            if (this._scaleMode == egret.StageScaleMode.SHOW_ALL || this._scaleMode == egret.StageScaleMode.NO_BORDER) {
                if (this._windowW == this._displayW) {
                    this._imgWrapper.style.left = this.scale * this._x / this._stageW * this._windowW + "px";
                    ...
                    this._imgWrapper.style.left = this.scale * this._x / this._stageW * this._displayW + "px";
                }
            }
        },
        enumerable: true,
    ...
    Object.defineProperty(WebImage.prototype, "y", {
        ...
        set: function (value) {
            this._y = value;
            if (this._scaleMode == egret.StageScaleMode.FIXED_WIDTH || this._scaleMode == egret.StageScaleMode.FIXED_HEIGHT) {
                this._imgWrapper.style.top = this.scale * this._y / this._stageH * this._windowH + "px";
            }
            if (this._scaleMode == egret.StageScaleMode.SHOW_ALL || this._scaleMode == egret.StageScaleMode.NO_BORDER) {
                if (this._windowH == this._displayH) {
                    this._imgWrapper.style.top = this.scale * this._y / this._stageH * this._windowH + "px";
                    ...
                    this._imgWrapper.style.top = this.scale * this._y / this._stageH * this._displayH + "px";
                }
            }
        },
        enumerable: true,
    ...
    WebImage.prototype.addClick = function (callfun) {
        this._img.ontouchend = callfun;
    };
    WebImage.prototype.removeClick = function () {
