...
var ServerManager = (function (_super) {
    ...
    ServerManager.prototype.resetPlay = function (cmdData) {
        ...
        var r = Math.floor(Math.random() * serverData.playDataArr.length);
        ...
        var obj = {
            'freeslot': { 'count': this.total - this.count, 'total': this.total, 'TotalWin': 10, 'ActionWin': this.ActionWin },
        };
        ...
        if (ServerManager.WhetherFree) {
            ...
            this.ActionWin = 0;
            for (var k = 0; k < WinResults.length; k++) {
    ...
    ServerManager.prototype.isallNum = function (n, arr) {
    ...
    ServerManager.prototype.isAllW = function (arr) {
        for (var i = 0; i < arr.length; i++) {
            var carr = arr[i];
            var s = carr[0];
    ...
    ServerManager.WhetherFree = false; //是否免费
    ...
    serverData.playData = {
        ...
        "Value": {
            ...
            "Main": {
                ...
                "ReelResults": [{ "Idx": 0, "Pos": 3 }, { "Idx": 1, "Pos": 5 }, { "Idx": 2, "Pos": 4 }, { "Idx": 3, "Pos": 7 }, { "Idx": 4, "Pos": 1 }, { "Idx": 5, "Pos": 2 }],
                "ReelSymbols": [["AA", "TN", "JJ", 'WW'], ["M2", "WW", "M5", 'QQ'], ["M1", "M5", "M4", 'AA'], ["WW", "JJ", "M4", 'QQ'], ["M1", "M5", "TN", 'AA'], ["NI", "M3", "M4", 'M5']],
