...
var GameManager = (function (_super) {
    ...
    GameManager.prototype.onNetGamePlay = function (data) {
        ...
        if (vo.GameData.resultData.ActionType != 'freeslot' && (this.getFreeCount() <= 0) && !GameConfig.speedPlay && SoundManager.getInstance().effectOn && this.chanel == null && egret.getTimer() - this.curtime > 400) {
            ...
            SoundManager.getInstance().playMusic(SoundConst.REEL, 1).then(function (chanel) {
                _this.chanel = chanel;
            });
        }
    ...
    GameManager.prototype.playMusic = function (music) {
        var _this = this;
        if (SoundManager.getInstance().effectOn && this.chanel == null) {
            SoundManager.getInstance().playMusic(music, 1).then(function (chanel) {
                _this.chanel = chanel;
            });
        }
    };
    ...
    GameManager.prototype.noMoney = function () {
        ...
        ui.shows(0, '余额不足，无法下所请求的赌注。', '请下一个较低的赌注，或访问 出纳柜台 进行存款。', function () {
            core.UIManager.closeUI(core.UIConst.StipsUI);
        });
    };
    ...
    GameManager.prototype.startGame = function (isUsolt) {
