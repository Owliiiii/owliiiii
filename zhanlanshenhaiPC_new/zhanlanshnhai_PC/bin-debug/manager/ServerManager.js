...
var ServerManager = (function (_super) {
    ...
    ServerManager.prototype.resetPlay = function (cmdData) {
        ...
        var resultArr = [[], [], []];
        //先得到盘面数据
        var iarr = serverData.initData.Value.Symbolstripes.Main.Stripes;
        for (var i = 0; i < iarr.length; i++) {
            var sarr = iarr[i].Symbols;
            var pos = data.Value.Main.ReelResults[i].Pos + 1 > sarr.length - 1 ? 0 : data.Value.Main.ReelResults[i].Pos + 1;
            for (var j = 0; j < Reel.ShowNum; j++) {
