...
var WebView = (function (_super) {
    ...
    function WebView(src) {
        ...
        egret.log("windowW:" + _this._windowW);
        egret.log("stageW:" + _this._stageW);
        egret.log("disPlayW:" + _this._displayW);
        egret.log("windowH:" + _this._windowH);
        egret.log("stageH:" + _this._stageH);
        egret.log("displayH:" + _this._displayH);
        return _this;
    ...
    Object.defineProperty(WebView.prototype, "width", {
        ...
        set: function (value) {
            ...
            if (this._scaleMode == egret.StageScaleMode.FIXED_WIDTH || this._scaleMode == egret.StageScaleMode.FIXED_HEIGHT) {
                this._iframe.style.width = this.scale * this._width / this._stageW * this._windowW + "px";
                this._iframeWrapper.style.width = this.scale * this._width / this._stageW * this._windowW + "px";
            }
            if (this._scaleMode == egret.StageScaleMode.SHOW_ALL || this._scaleMode == egret.StageScaleMode.NO_BORDER) {
                if (this._windowW == this._displayW) {
                    ...
                    this._iframe.style.width = this.scale * this._width / this._stageW * this._displayW + "px";
                    this._iframeWrapper.style.width = this.scale * this._width / this._stageW * this._displayW + "px";
                }
            }
            else {
                this._iframe.style.width = this.scale * value / window.devicePixelRatio + "px";
                this._iframeWrapper.style.width = this.scale * value / window.devicePixelRatio + "px";
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(WebView.prototype, "height", {
        ...
        set: function (value) {
            this._height = value;
            if (this._scaleMode == egret.StageScaleMode.FIXED_WIDTH || this._scaleMode == egret.StageScaleMode.FIXED_HEIGHT) {
                this._iframe.style.height = this.scale * this._height / this._stageH * this._windowH + "px";
                this._iframeWrapper.style.height = this.scale * this._height / this._stageH * this._windowH + "px";
            }
            if (this._scaleMode == egret.StageScaleMode.SHOW_ALL || this._scaleMode == egret.StageScaleMode.NO_BORDER) {
                if (this._windowH == this._displayH) {
                    ...
                    this._iframe.style.height = this.scale * this._height / this._stageH * this._displayH + "px";
                    this._iframeWrapper.style.height = this.scale * this._height / this._stageH * this._displayH + "px";
                }
            }
            else {
                this._iframe.style.height = this.scale * value / window.devicePixelRatio + "px";
                this._iframeWrapper.style.height = this.scale * value / window.devicePixelRatio + "px";
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(WebView.prototype, "x", {
        ...
        set: function (value) {
            this._x = value;
            if (this._scaleMode == egret.StageScaleMode.FIXED_WIDTH || this._scaleMode == egret.StageScaleMode.FIXED_HEIGHT) {
                this._iframeWrapper.style.left = this.scale * this._x / this._stageW * this._windowW + "px";
            }
            if (this._scaleMode == egret.StageScaleMode.SHOW_ALL || this._scaleMode == egret.StageScaleMode.NO_BORDER) {
                if (this._windowW == this._displayW) {
                    this._iframeWrapper.style.left = this.scale * this._x / this._stageW * this._windowW + "px";
                    ...
                    this._iframeWrapper.style.left = this.scale * this._x / this._stageW * this._displayW + "px";
                }
            }
            else {
                this._iframe.style.left = 0 + "px";
                this._iframeWrapper.style.left = this.scale * value / window.devicePixelRatio + "px";
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(WebView.prototype, "y", {
        ...
        set: function (value) {
            this._y = value;
            if (this._scaleMode == egret.StageScaleMode.FIXED_WIDTH || this._scaleMode == egret.StageScaleMode.FIXED_HEIGHT) {
                this._iframeWrapper.style.top = this.scale * this._y / this._stageH * this._windowH + "px";
            }
            if (this._scaleMode == egret.StageScaleMode.SHOW_ALL || this._scaleMode == egret.StageScaleMode.NO_BORDER) {
                if (this._windowH == this._displayH) {
                    this._iframeWrapper.style.top = this.scale * this._y / this._stageH * this._windowH + "px";
                    ...
                    this._iframeWrapper.style.top = this.scale * this._y / this._stageH * this._displayH + "px";
                }
            }
            else {
                this._iframe.style.top = 0 + "px";
                this._iframeWrapper.style.top = this.scale * value / window.devicePixelRatio + "px";
            }
        },
        enumerable: true,
        configurable: true
