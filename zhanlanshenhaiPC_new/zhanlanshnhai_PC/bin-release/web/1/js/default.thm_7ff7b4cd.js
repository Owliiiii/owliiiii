window.skins={};
...
})(eui.Skin);generateEUI.paths['resource/eui_skins/skins/game/main/DuanxianSkin.exml'] = window.DuanxianSkin = (function (_super) {
	__extends(DuanxianSkin, _super);
	function DuanxianSkin() {
		_super.call(this);
		this.skinParts = ["bg","img","desLabel","closeBtn","allGroup"];
		
		this.height = 990;
		this.width = 1600;
		this.elementsContent = [this.bg_i(),this.allGroup_i()];
	}
	var _proto = DuanxianSkin.prototype;
	...
	_proto.allGroup_i = function () {
		...
		t.horizontalCenter = 0;
		t.verticalCenter = 0;
		t.elementsContent = [this.img_i(),this.desLabel_i(),this.closeBtn_i()];
		return t;
	};
	...
	function MainScenceUISkin() {
		_super.call(this);
		this.skinParts = ["bg","bg1","gameScence","logo1","logo2","free_fanbei","free_Num","free_money","free_group","logo_group","mcGroup","bigRewardLabel","bigRewardGroup","aGroup","lineLabel","betLabel","allBetLabel","infoBtn","lineSubBtn","lineAddBtn","betSubBtn","betAddBtn","speedOffBtn","speedOnBtn","speedOffTxt","autoItem","speedOnTxt","startBtn","bonusBtn","stopBtn","bonusBtnShan","rewardLabel","rewardGroup","tool_group","mainGroup","rotateNum","fanbeiNum","freeNumGroup","beiKe_0","beiKe_x0","beiKe_1","beiKe_x1","beiKe_2","beiKe_x2","beiKe_3","beiKe_x3","beiKe_4","beiKe_x4","freeGroup","pickFreeBtn","freeNum","beiNum","pickFree","overFreeBtn","gameMoney","gongNengMoney","totalMoney","overFree","tipsGroup","tGameBtn","setBar","t0","t1","t2","t3","t4","textGroup","topList","topListGroup","topMask","topGroup","timeLabel","balanceLabel","bottomMask","bottomGroup"];
		
		this.height = 990;
		this.width = 1920;
		this.elementsContent = [this.bg_i(),this.bg1_i(),this.mainGroup_i(),this.freeGroup_i(),this.tipsGroup_i(),this.topGroup_i(),this.bottomGroup_i(),this._Image22_i(),this._Image23_i()];
	}
	...
	_proto.mainGroup_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1266;
		t.elementsContent = [this.gameScence_i(),this.logo_group_i(),this.aGroup_i(),this.tool_group_i()];
		return t;
	};
	...
	_proto.freeGroup_i = function () {
		...
		t.visible = false;
		t.width = 1444;
		t.elementsContent = [this._Image9_i(),this.freeNumGroup_i(),this._BitmapLabel1_i(),this._BitmapLabel2_i(),this.beiKe_0_i(),this.beiKe_x0_i(),this.beiKe_1_i(),this.beiKe_x1_i(),this.beiKe_2_i(),this.beiKe_x2_i(),this.beiKe_3_i(),this.beiKe_x3_i(),this.beiKe_4_i(),this.beiKe_x4_i()];
		return t;
	};
	_proto._Image9_i = function () {
		var t = new eui.Image();
	...
	_proto.freeNumGroup_i = function () {
		...
		t.x = 815;
		t.y = 52;
		t.elementsContent = [this._Image10_i(),this._Image11_i(),this.rotateNum_i(),this.fanbeiNum_i()];
		return t;
	};
	_proto._Image10_i = function () {
		var t = new eui.Image();
	...
	_proto.tipsGroup_i = function () {
		...
		t.visible = false;
		t.width = 1444;
		t.elementsContent = [this._Image12_i(),this.pickFree_i(),this.overFree_i()];
		return t;
	};
	_proto._Image12_i = function () {
		var t = new eui.Image();
	...
	_proto.pickFree_i = function () {
		...
		t.width = 985;
		t.y = 136;
		t.elementsContent = [this.pickFreeBtn_i(),this._Image13_i(),this.freeNum_i(),this.beiNum_i()];
		return t;
	};
	...
	_proto.overFree_i = function () {
		...
		t.width = 985;
		t.y = 146;
		t.elementsContent = [this.overFreeBtn_i(),this._Image14_i(),this._Image15_i(),this._Image16_i(),this._Image17_i(),this.gameMoney_i(),this.gongNengMoney_i(),this.totalMoney_i()];
		return t;
	};
	...
	_proto.topGroup_i = function () {
		...
		t.top = 0;
		t.width = 1920;
		t.elementsContent = [this._Image18_i(),this.tGameBtn_i(),this.setBar_i(),this.textGroup_i(),this.topListGroup_i(),this.topMask_i()];
		return t;
	};
	...
	_proto.topListGroup_i = function () {
		...
		t.touchThrough = true;
		t.y = -155;
		t.elementsContent = [this._Image19_i(),this.topList_i()];
		return t;
	};
	...
	_proto.bottomGroup_i = function () {
		...
		t.horizontalCenter = 0;
		t.width = 1920;
		t.elementsContent = [this._Image20_i(),this.timeLabel_i(),this._Group4_i(),this.bottomMask_i()];
		return t;
	};
	...
	_proto._Group4_i = function () {
		...
		t.elementsContent = [this._Image21_i(),this.balanceLabel_i(),this._MouseButton1_i()];
		return t;
	};
